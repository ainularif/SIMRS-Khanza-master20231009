...
public final class ReklasifikasiRanap extends javax.swing.JDialog {
    ...
    public ReklasifikasiRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new String[]{
            "No.Rawat","No.RM","Pasien","Cara Bayar","Waktu Masuk","Waktu Keluar",
            "LOS(hari)","J.K.","Tgl.Lahir","Tipe Rawat","Kelas Rawat", "Bangsal",
        ...
        for (int i = 0; i < 93; i++) {
            ...
            if(i==0){
                ...
                column.setPreferredWidth(100);//Tambah Kolom nama pasien
            }else if(i==3){
                ...
                column.setPreferredWidth(120);//Tambah Kolom Bangsal
            }else if(i==12){
                column.setPreferredWidth(70);
                    ...
                    (i==64)||(i==65)||(i==67)||(i==68)||(i==69)||(i==70)||(i==71)||(i==72)){
    ...
    public void tampil(){
        ...
        try{      
            ps= koneksi.prepareStatement(
                ...
                "kamar_inap.stts_pulang,kamar_inap.lama,pasien.jk,pasien.tgl_lahir,kamar.kelas,bangsal.nm_bangsal "+ //nambah bangsal
                "from kamar_inap inner join reg_periksa "+
                "inner join pasien inner join penjab inner join kamar inner join nota_inap inner join bangsal "+ //nambah inner join bangsal
                ...
                "and kamar.kd_bangsal = bangsal.kd_bangsal "+ //Nama bangsal
                "where kamar_inap.tgl_masuk between ? and ? and reg_periksa.kd_pj like ? "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    if(!rs.getString("stts_pulang").equals("Pindah Kamar")){
                        ...
                        tabMode.addRow(new Object[]{
                            rs.getString("no_rawat"),rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),rs.getString("png_jawab"),//Tambah  nm_pasien
                            rs.getString("tgl_masuk")+" "+rs.getString("jam_masuk"),rs.getString("tgl_keluar")+" "+rs.getString("jam_keluar"),
                            rs.getString("lama"),rs.getString("jk"),rs.getString("tgl_lahir"),"Ranap",rs.getString("kelas"),rs.getString("nm_bangsal"),//Tambah nm_bangsal
                ...
                if(all>0){
                    tabMode.addRow(new Object[]{
                        ...
                        "","","","","","","","","","","","","","","","","","","","","","","","",
                        "","","","","","","","","","","","","","","","","","","","","","","","",
                        "","","","",Valid.SetAngka(all),Valid.SetAngka(ttlkebidanan),Valid.SetAngka(ttlOperasi-ttlkebidanan), //Penambahan
