...
*/
        ...
        if(TabPilihRawat.getSelectedIndex()==0){
            if(TabRawatJalan.getSelectedIndex()==0){
                if(tabMode.getRowCount()==0){
                    ...
                    JOptionPane.showMessageDialog(null,"Maaf, Silahkan pilih data pasien ingin di telaah..!!");
                }else{
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    InventoryTelaahResep aplikasi=new InventoryTelaahResep(null,false);
                    aplikasi.emptTeks();
                    aplikasi.isCek();
                    aplikasi.setNoRm(tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(),0).toString(),tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(),3).toString(),DTPCari2.getDate());
                    aplikasi.tampil();
            ...
            if(TabRawatInap.getSelectedIndex()==0){
                if(tabMode3.getRowCount()==0){
                    ...
                    aplikasi.emptTeks();
                    aplikasi.isCek();
                    aplikasi.setNoRm(tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(),0).toString(),tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(),3).toString(),DTPCari2.getDate());
                    aplikasi.tampil();
                    aplikasi.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                    aplikasi.setLocationRelativeTo(internalFrame1);
                    aplikasi.setVisible(true);
                ...
                JOptionPane.showMessageDialog(null,"Maaf, klik anda salah!!!!");
                TCari.requestFocus();
            }      
        }
    ...
    */
    ...
    public void isCek(){
        ...
        //Custom (Menambahkan akses tombol tambah, edit, hapus, penyerahan)
        BtnTambah.setEnabled(akses.getresep_obat());
        BtnEdit.setEnabled(akses.getresep_obat());
        BtnHapus.setEnabled(akses.getresep_obat());
        BtnPenyerahan.setEnabled(akses.getresep_obat());
        ...
        //Custom (Tambah tombol Telaat Resep)
        ...
        try{  
            ...
            if(DEPOAKTIFOBAT.equals("")){
                ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                        ...
                        //Custom (Hapus query kamar_inap.stts_pulang='-')
